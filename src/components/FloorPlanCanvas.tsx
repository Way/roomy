...
export function FloorPlanCanvas() {
  ...
  const handleFurnitureContextMenu = useCallback(
    (e: { itemId: string; clientX: number; clientY: number }) => {
      setContextMenu({ itemId: e.itemId, x: e.clientX, y: e.clientY });
    },
    []
  );
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      >
        ...
        {contextMenu && (
          <div
            className="fixed z-50 min-w-35 bg-popover border border-border rounded-md shadow-md py-1 text-sm"
          ...
          >
            <button
              ...
              onClick={() => {
                selectFurniture(contextMenu.itemId);
                setContextMenu(null);
              }}
            >
            ...
            <button
              className="w-full px-3 py-1.5 text-left hover:bg-accent hover:text-accent-foreground flex items-center gap-2"
              onClick={() => {
                duplicateFurniture(contextMenu.itemId);
                setContextMenu(null);
              }}
            >
            ...
            <button
              ...
              onClick={() => {
                removeFurniture(contextMenu.itemId);
                setContextMenu(null);
              }}
            >
